        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="minimal-card p-8 hover-lift">
                    ...
                    <p class="text-gray-700 mb-4 italic">"Finally, a parenting book that made me laugh instead of
                        stress! Juan's humor is exactly what overwhelmed parents need."</p>
                ...
                <div class="minimal-card p-8 hover-lift">
                    ...
                    <p class="text-gray-700 mb-4 italic">"Juan's book is a breath of fresh air! His humor made me
                        realize I'm not alone in this parenting journey."</p>
                ...
                <div class="minimal-card p-8 hover-lift">
                    <div class="flex items-center mb-4">
                        <div class="flex text-yellow-400">
                            ...
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                <path
                                    d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24 .588,1 .81,2 .034,7 .034,7s-.197,4 .118,4 .197,4 .197,4
                    ...
                    <p class="text-gray-700 mb-4 italic">"A hilarious and insightful read! Juan's book is a must-have
                        for any parent looking to find joy amidst the chaos."</p>
