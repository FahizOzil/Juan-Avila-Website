...
<body>
    <div class="email-container">
        <div class="company-logo">
            ...
            <img src="{{ asset('images/book-cover.jpg')}}" alt="Juan Book Logo">
        </div>
        ...
        <p>We appreciate your interest in "Under The Weight Of Forgetting " and will respond to your inquiry as soon as possible.</p>

        <div class="footer">
            <div class="signature">
                <p>Best regards,</p>
                <p><strong>Anne Starland</strong> (Minna Blue)</p>
                <p>"Under The Weight Of Forgetting "</p>
            </div>
            ...
            <div class="contact-info">
                ...
                <p>Email:contact@authorjuanavila.com</p>
                <p>Website:www.authorjuanavila.com</p>
            </div>
